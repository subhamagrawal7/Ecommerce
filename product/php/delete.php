...
include_once $_SERVER['DOCUMENT_ROOT'] . "/Ecommerce/php/dbh.php";
  ...
  $output = "";
  $output .= "<div class='container'><h1 class='display-1'>DELETE Product...</h1>
  ...
  $output .= "</tbody></table><br><form action='../product_HomePage.html'>
  <div class='form-group row'>
    <div class='col-sm-10'>
      <button type='submit' class='btn btn-primary' name='return' onclick='../product_HomePage.html'>Return</button>
    </div>
  </div>
</form></div>";
  echo $output;
